...
#         input_data[feature] = st.number_input(f"Enter {feature}:", value=float(X_test[feature].mean()), step=1)
...
# # Use st_shap for SHAP force plot
# fig = shap.force_plot(explainer.expected_value[0], shap_values_input[0], input_df)
# st_shap(fig)

# # Decision plot
# st.subheader("Decision Plot")
# # Use st_shap for SHAP decision plot
# fig = shap.decision_plot(explainer.expected_value[0], shap_values_input[0], X_test.columns)
# st_shap(fig)
